...
public class Effect_Shake : MonoBehaviour
{
    ...
    [SerializeField] private GameObject ref_sprite = null;
    ...
    public void Shake(float new_shake_multiplier = 1f)
    {
    ...
    private void Start()
    {
        shake_time_start = 0;
        shake = false;
        original_pos = ref_sprite.transform.localPosition;
    }
    ...
    private void Update()
    {
        ...
        if (shake && (e_time) < shake_duration_seconds)
        {
            ...
            ref_sprite.transform.localPosition = new Vector3(
        ...
        {
            shake = false;
            ref_sprite.transform.localPosition = original_pos;
        }
    }
}
